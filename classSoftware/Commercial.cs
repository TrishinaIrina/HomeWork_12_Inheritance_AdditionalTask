...
namespace HomeWork_12_Inheritance_AdditionalTask.classSoftware
{
    ...
    {
        public Commercial(string title, string manufacturer, string installationDate, int termOfUse) : base(title, manufacturer)
        {
            type = "коммерческое";
        ...
        public override void ShowInfo()
        {
            ...
            Console.WriteLine("срок использования (дней): " + termOfUse);
        }
    }
}
